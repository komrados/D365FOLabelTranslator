...
namespace LabelTranslator
{
    ...
    internal sealed class TranslateCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("a88414b8-243a-4473-94c7-3649bac4849e");
        ...
        {
            EnvDTE.UIHierarchyItem hierarchyItem = GetSelectedSolutionExplorerItem();

            ProjectItem prjItem = hierarchyItem.Object as ProjectItem;
            string filePath = prjItem.Properties.Item("FullPath").Value.ToString();

            CommandParameters commandData = new CommandParameters(filePath);

            LabelTranslationOptionPage options = (LabelTranslationOptionPage)package.GetDialogPage(typeof(LabelTranslationOptionPage));

            LabelTranslatorEngine labelTranslatorEngine = new LabelTranslatorEngine();
            labelTranslatorEngine.Execute(options, commandData);

            ThreadHelper.ThrowIfNotOnUIThread();
            string message = labelTranslatorEngine.Report;
            string title = "Label translator";
